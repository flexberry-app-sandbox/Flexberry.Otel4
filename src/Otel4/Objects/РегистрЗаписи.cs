...
namespace IIS.Otel4
{
    ...
    public class РегистрЗаписи : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Otel4.Доступ fДоступ;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Otel4.Доступ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Доступ"})]
        public virtual IIS.Otel4.Доступ Доступ
        {
            get
            {
                ...
                IIS.Otel4.Доступ result = this.fДоступ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистрЗаписиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистрЗаписиE", typeof(IIS.Otel4.РегистрЗаписи));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРегистрЗаписи : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Otel4.DetailArrayOfРегистрЗаписи members)

        // *** End programmer edit section *** (IIS.Otel4.DetailArrayOfРегистрЗаписи members)
        ...
        /// </summary>
        public DetailArrayOfРегистрЗаписи(IIS.Otel4.Доступ fДоступ) : 
                base(typeof(РегистрЗаписи), ((ICSSoft.STORMNET.DataObject)(fДоступ)))
        {
        }
        
        public IIS.Otel4.РегистрЗаписи this[int index]
        {
            get
            {
                return ((IIS.Otel4.РегистрЗаписи)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Otel4.РегистрЗаписи dataobject)
        {
