...
namespace IIS.Otel4
{
    ...
    public class СмартКлюч : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Otel4.Статусы fСтатус;
        ...
        public virtual IIS.Otel4.Статусы Статус
        {
            get
            {
                ...
                IIS.Otel4.Статусы result = this.fСтатус;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СмартКлючE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СмартКлючE", typeof(IIS.Otel4.СмартКлюч));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СмартКлючL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СмартКлючL", typeof(IIS.Otel4.СмартКлюч));
                }
            }
        }
    }
