...
namespace IIS.Otel4
{
    ...
    public class Гости : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ГостиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГостиE", typeof(IIS.Otel4.Гости));
                }
            }
        }
    }
    ...
    public class DetailArrayOfГости : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Otel4.DetailArrayOfГости members)

        // *** End programmer edit section *** (IIS.Otel4.DetailArrayOfГости members)
        ...
        /// </summary>
        public DetailArrayOfГости(IIS.Otel4.Доступ fДоступ) : 
                base(typeof(Гости), ((ICSSoft.STORMNET.DataObject)(fДоступ)))
        {
        }
        
        public IIS.Otel4.Гости this[int index]
        {
            get
            {
                return ((IIS.Otel4.Гости)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Otel4.Гости dataobject)
        {
